...
public class Ahorros {
	...
	private Scanner sc;
	int[] num_ahorros = new int[150];
	String[] nombre_ahorros= new String[150];
	int[] saldo_ahorros= new int[150];
	...
	*/
	...
	public void ConsultarAhorros() {
		...
		for(int i=1;i<=a;i++) {
			System.out.println(i+".)El nombre del usuario es: "+this.nombre_ahorros[i]);
			System.out.println(i+".)El numero de la cuenta es: "+this.num_ahorros[i]);
			System.out.println(i+".)Saldo del cliente es: "+this.saldo_ahorros[i]);
	...
	public void DepositarAhorros() {
		sc =new Scanner(System.in);
		
		System.out.println("Usted decidio depositar dinero a la cuenta de ahorros.");
